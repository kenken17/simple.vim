...
let g:simple_bold = get(g:, '_bold', 0)
  ...
  hi @preproc guifg=NONE ctermfg=NONE guibg=#d70000 ctermbg=160 gui=NONE cterm=NONE
  ...
  hi @symbol guifg=NONE ctermfg=NONE guibg=#d70000 ctermbg=160 gui=NONE cterm=NONE
  hi link @tag Tag
